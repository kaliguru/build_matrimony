...
const successStories_1 = __importDefault(require("../../controllers/admin/successStories"));
 ...
 */
// #endregion
router.post('/activeInactiveSuccessStories', successStories_1.default.activeInactiveSuccessStories);
